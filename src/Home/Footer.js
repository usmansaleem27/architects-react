      ...
      <div className='container g-0'>
        <div className='row g-0'>
            <div className='col-lg-6 col-12'>
                <div className='footer_input_box ps-lg-3 ps-md-3 pe-md-3 ms-lg-2 pe-lg-3 pt-3 mb-5 me-lg-5 mt-5 ps-2 pe-2 ms-md-3 ms-3 me-md-3 me-3'><div className='d-flex justify-content-center'>
